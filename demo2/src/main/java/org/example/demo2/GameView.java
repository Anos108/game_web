...
import static org.example.demo2.MainMenuController.mediaPlayer;
...
public class GameView extends Application {
  ...
  private void update() {
    ...
    if (Config.interact(ball.getBounds(), paddle.getBounds())) {
      URL music = getClass().getResource("/asset/sounds/brick_hit.mp3");
      assert music != null;
      Media hitSound = new Media(music.toExternalForm());
      mediaPlayer = new MediaPlayer(hitSound);
      mediaPlayer.play();
